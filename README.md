...
now <mark>userDevice</mark> variable can store Phone's properties or Computer's properties.
...
now <mark>userWithRole</mark> variable must contain the properties of <mark>User</mark> and properties of <mark>Role</mark>. Otherwise TypeScript will throw an error.